...
class EstoqueModule extends Module {
  ...
  List<Module> get imports => [
        ProdutoModule(), // Importa o módulo de produto (ProdutoCubit e ProdutoService)
      ];
  ...
  void binds(Injector i) {
    ...
    i.addLazySingleton<EstoqueCubit>(() => EstoqueCubit(
          produtoService: i.get(), // usa ProdutoService do ProdutoModule
          caixaService: i.get(),
        ));
  }
  ...
  void routes(RouteManager r) {
    r.child(
      '/', // sempre com barra para evitar o warning do Modular
